		...
		<Dialog>
			...
			<DialogContent className='sm:max-w-[725px] max-h-200 flex flex-col bg-card '>
				...
				<div className=' relative'>
					<textarea className='w-full h-150 outline-none p-4 border rounded py-2 resize-none scroll bg-background font-mono text-muted-foreground ' spellCheck={false}>
						{dynamicCSS}
					</textarea>
